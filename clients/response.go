...
import "github.com/andrew-hayworth22/wodify-go/models"
...
type Client struct {
	...
	MemberSince models.Date `json:"member_since"`
	// Last time the client was contacted.
	LastContacted models.Date `json:"last_contacted"`
	// Indicates whether the client is at risk.
	IsAtRisk bool `json:"is_at_risk"`
	// Date that the client will be snoozed until
	RetainSnoozeUntilDate models.Date `json:"retain_snooze_until_date"`
	...
	UpdatedAt models.Created `json:"updated"`
}
